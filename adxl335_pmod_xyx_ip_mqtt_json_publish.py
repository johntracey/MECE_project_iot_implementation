...
if out_buffer_x.any() >= 0 and out_buffer_y.any() >= 0 and int(out_buffer_z.any() <= 450) :
    print("Huston we have a problem - Alarm Activated!!")
else:
    print("System stable no alarms ")

#Testing creating a json object for transfer over network using MQTT
#note: import json
#JSON convert python to JSON 
#the json object is the adxl alarm readings
...
client.publish("project/temp",axdl_tx)
